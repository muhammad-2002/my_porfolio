      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <div>
            ...
            <Link
              href="https://drive.google.com/file/d/1guHPCAAOvaqHBGoyaGm4_wIa1kIe7v6L/view"
              target="_blank"
        ...
        >
          <div className="rounded-full bg-[#181818] w-[250px] h-[250px] lg:w-[400px] lg:h-[400px] relative">
            <Image
              ...
              alt="hero image"
              className=" absolute w-[59%] lg:w-[75%] transform -z-1 rounded-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
              width={300}
              height={300}
            />
          </div>
